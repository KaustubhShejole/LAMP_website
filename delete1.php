...
<div class="container">
	<center>
		...
		try {
			...
			echo "hello";*/
			?>
			<h1>Deleting Form data in Student Database</h1>
		...
		<div class="row">
			<div class="col-25">
    			...
    			<div class="col-75">
      				<?php
      				echo '<input type="text" id="name" name="name" value='.$name.' readonly="readonly">';
      				?>
    			</div>
		</div>
		...
		<div class="row">
			<div class="col-25">
    			...
    			<div class="col-75">
      				<?php
      				echo '<input type="text" id="email" name="email" value='.$email.' readonly="readonly">';
      				?>
    			</div>
		</div>
